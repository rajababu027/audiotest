import 'package:audiotest/utilities/speech_to_text/speech_commands.dart';
import 'package:audiotest/utilities/speech_to_text/speech_recognizer.dart';
              ...
              child: Row(
                ...
                children: [
                  IconButton(
                    ...
                    tooltip: 'Copy text',
                    onPressed: () {
                      Clipboard.setData(ClipboardData(text: _speechResult))
                          .then(
                        (value) {
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                SpeechRecognizer.toggleRecording(
                  onSpeech: (value) =>
                      setState(() => this._speechResult = value),
                  onListening: (value) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                          'Please install or enable Google app to allow Speech Recognition Service'),
                      behavior: SnackBarBehavior.floating,
                    ),
                  );
                });
